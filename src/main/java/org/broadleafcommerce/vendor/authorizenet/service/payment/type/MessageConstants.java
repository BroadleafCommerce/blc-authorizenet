...
public class MessageConstants {
    ...
    public static final String X_RESPONSE_CODE = "x_response_code";
    ...
    public static final String X_ACCOUNT_NUMBER = "x_account_number";
    public static final String X_CARD_TYPE = "x_card_type";
